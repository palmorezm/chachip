...
shinyUI(navbarPage(title = img(src="Rock-County-Logo.png", 
                               height = "40px"), 
                   id = "navBar",
                   collapsible = TRUE,
                   inverse = FALSE,
...
HTML("
                                     ...
                                     <h2 class='parallax'>CHA-CHIP Dashboard</h2>
                                     <p class='parallax_description'>2021-2025 CHA-CHIP Cycle</p>
                                     </section>
                                     ")
                                # shiny::HTML(
                                #   "<!-- Slideshow container -->
                            ...
                            #     shiny::HTML("<center> <h1>Welcome to the CHA CHIP Dashboard</h2></center>"),
                            ...
                            #            carouselPanel(
                            #                # tags$a(href = "#FAQ", 
                            # experiment diff size img - fixed height 1080px and width 1900px
                            #                #        tags$img(src = "screen_capture_absenteeism_2.jpg", width = "615px")), 
                            ...
                            fluidRow(
                                column(2),
                                column(8, box(
                                    shinydashboard::valueBoxOutput(outputId = "ova", width = 4),
                                    shinydashboard::valueBoxOutput(outputId = "ovb", width = 4),
                                    shinydashboard::valueBoxOutput(outputId = "ovc", width = 4),
                                    width = 12
                                )), 
                                column(2)
                            ),
                            ...
                            fluidRow(
                                ...
                                column(6,
                                       ...
                                       shiny::HTML("<h5>With most things, the more you know, the better your decisions 
                                                   will be. The CHA CHIP Dashboard empowers you to make better decisions 
                            ...
                            fluidRow(
                                ...
                                column(6,
                                       ...
                                       shiny::HTML("<h5>Our team analyzed over 500 thousand County employee records 
                                                   ...
                                                   you will see in the CHA CHIP Dashboard.</h5>")
                                       ),
                                column(3)
                                       ),
                            ...
                            fluidRow(
                                ...
                                column(6,
                                       ...
                                       shiny::HTML("<h5>To launch the CHA CHIP Dashboard, choose one of the options below. 
                                                   You will not be asked to provide any identifiable information, and 
                                                   you can revisit the CHA CHIP Dashboard to chart a different course 
                   ...
                   ),  # Closes the second tabPanel called "CHA CHIP Dashboard"
                   
                   tabPanel("ABOUT", value = "about",
                            
                            fluidRow(
                                shiny::HTML("<br><br><center> 
                                            <h1>About CHA-CHIP</h1> 
                            ...
                            fluidRow(
                                div(align = "center",
                                    tags$span(h4("A Brief History of Rock County's CHA CHIP Work"), 
                            ...
                            fluidRow(
                                ...
                                column(6,
                                       tags$ul(
                                           tags$li(h6("The need for the CHA CHIP Dashboard grew out of the fact that it is simply difficult to navigate the classification structure if you do not already know it or know someone who has gone through it.")), 
                            ...
                            fluidRow(
                                ...
                                column(6,
                                       ...
                                       shiny::HTML("<h6>The CHA CHIP Dashboard is sponsored by the Los Angeles County 
